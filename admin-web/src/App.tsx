...
function Reports() {
  ...
  return (
    <Page
      eyebrow="Moderation"
      title="Open reports"
      description="Review reports across every Nuxx community."
    >
...
function FeedbackList() {
  ...
  return (
    <Page
      eyebrow="Product"
      title="Feedback"
      description="Recent product feedback from across Nuxx."
    >
      <StateView resource={resource}>
        {(items) => {
...
const FEEDBACK_STATUS_KEY = "nuxx-admin-feedback-status";
