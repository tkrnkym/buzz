"""Harbor custom-agent entry point for Nuxx orchestration."""
...
from .container_runtime import NuxxContainerRuntime, EndpointLaunchConfig
from .manifest import ExperimentManifest
from .provisioning import TrialProvisioner
from .runtime import OrchestraRuntime


class NuxxOrchestraAgent(BaseAgent):
    """Coordinate an arbitrary manifest-defined team through a Nuxx trial."""
    ...
    def _build_runtime(
        ...
        nuxx_acp_binary: str,
        nuxx_agent_binary: str,
        nuxx_dev_mcp_binary: str,
        nuxx_cli_binary: str,
        relay_gateway: str,
        ...
        return NuxxContainerRuntime(
            ...
            endpoints=endpoints,
            nuxx_acp_binary=nuxx_acp_binary,
            nuxx_agent_binary=nuxx_agent_binary,
            nuxx_dev_mcp_binary=nuxx_dev_mcp_binary,
            nuxx_cli_binary=nuxx_cli_binary,
    ...
    async def run(
        ...
        if self.provisioner is None or self.runtime is None:
            raise RuntimeError(
                "NuxxOrchestraAgent requires provisioner and runtime integrations; "
        ...
        context.metadata = {
            **result.metadata,
            ...
            "nuxx_channel_id": handle.channel_id,
            "run_id": run_id,
            "trial_id": trial_id,
        }
