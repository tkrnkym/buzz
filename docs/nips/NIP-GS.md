...
2. `NUXX_PRIVATE_KEY` environment variable.
...
1. `NUXX_AUTH_TAG` environment variable — a JSON-encoded array of 4 strings
...
(`NOSTR_PRIVATE_KEY`, `NUXX_PRIVATE_KEY`). Environment variables are visible
to:
