...
- Default `BUZZ_IMAGE` tracks `ghcr.io/tkrnkym/nuxx:main` for early testing. Pin it to `ghcr.io/tkrnkym/nuxx:sha-<7>` or a semver release tag for production once available.
