...
String downloadedImageFilename(String imageUrl, String? contentType) {
  ...
  return 'nuxx-${DateTime.now().millisecondsSinceEpoch}$extension';
}
...
/// Canonical `nuxx://message` link for a timeline message, including thread
...
/// hand off context (Copy link — the `nuxx://message` link is the workspace's
