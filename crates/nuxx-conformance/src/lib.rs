...
/// trace schema.
///
/// This deliberately does NOT reuse `nuxx_core::CommunityId`. Two reasons:
///
/// 1. **Production fence preservation.** `nuxx_core::CommunityId` has no
...
impl CommunityLabel {
    /// Wrap a UUID into a community label. Unlike `nuxx_core::CommunityId`
