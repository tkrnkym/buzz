...
pub fn sdk_err(e: nuxx_sdk::SdkError) -> CliError {
    match e {
        nuxx_sdk::SdkError::InvalidInput(msg) => CliError::Usage(msg),
...
mod tests {
    ...
    // and `normalize_mention_pubkeys` live in `nuxx_sdk::mentions` and are tested there.
