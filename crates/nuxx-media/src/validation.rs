...
mod tests {
    ...
    fn test_png_snapshot_text_chunk_rejected_when_duplicated_or_spoofed() {
        ...
        let mut payload = b"nuxx_agent_snapshot".to_vec();
        payload.push(0);
        ...
        // stay forbidden.
        for payload in [
            b"nuxx_agent_snapshotX\0data".as_slice(),
            b"nuxx_agent_snapshot_extra\0data",
            b"nuxx_agent_snapshot", // no separator at all
