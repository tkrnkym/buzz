...
impl RelayInfo {
    ...
    pub fn build(
        ...
        Self {
            ...
            push: None,
            software: "https://github.com/tkrnkym/buzz".to_string(),
...
mod tests {
    ...
    fn build_advertises_nuxx_repository_url() {
        ...
        assert_eq!(info.software, "https://github.com/tkrnkym/buzz");
    }
    ...
    fn auth_required_is_advertised_true() {
        ...
        // `AuthState::Authenticated` (see `crates/nuxx-relay/src/handlers/`),
