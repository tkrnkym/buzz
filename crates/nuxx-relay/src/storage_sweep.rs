...
//! classifier + pure fold live in `nuxx_media::bucket_index`). Summary:
//!
...
use nuxx_media::{BucketSnapshot, SweepError};
...
mod tests {
    ...
    use nuxx_media::CommunityStorage;
    ...
    // lock (`nuxx_db::UsageMetricsLeader`, see `crates/nuxx-db/src/lib.rs`)
