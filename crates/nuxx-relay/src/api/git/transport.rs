...
impl axum::extract::FromRequestParts<Arc<AppState>> for GitAuth {
    ...
    async fn from_request_parts(
        ...
        let pubkey =
            nuxx_auth::nip98::verify_nip98_event(&event_json, &expected_url, &event_method, None)
                .map_err(|e| {
...
fn read_role_allows(role: Option<&str>) -> bool {
    match role {
        Some(r) => r.parse::<nuxx_core::channel::MemberRole>().is_ok(),
        None => false,
    }
}
...
mod track_c_tests {
    ...
    fn git_nip98_rejects_token_signed_for_wrong_community_host() {
        ...
        let err = nuxx_auth::nip98::verify_nip98_event(&event_json, &expected_for_b, "GET", None)
    ...
    fn git_nip98_accepts_token_signed_for_matching_community_host() {
        ...
        let pubkey =
            nuxx_auth::nip98::verify_nip98_event(&event_json, &expected_for_a, "GET", None)
...
mod sec005_read_gate_tests {
    ...
    async fn setup_repo(binding: Binding) -> RepoFixture {
        ...
        db.add_member(
            ...
            channel,
            &member_pk,
            nuxx_core::channel::MemberRole::Member,
            Some(&creator_pk),
        )
        .await
        .expect("member");
