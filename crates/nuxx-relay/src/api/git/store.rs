...
//! ## The 412 sharp edge
//!
//! `rust-s3 = "0.37"` is shared across the workspace with `nuxx-media`. The
...
impl GitStore {
    ...
    ///
    /// Credential selection mirrors [`nuxx_media::MediaStorage::new`]:
    ...
    pub fn new(
        ...
        bucket_name: &str,
        region: &str,
        addressing_style: nuxx_media::config::S3AddressingStyle,
        ...
        let bucket = match addressing_style {
            nuxx_media::config::S3AddressingStyle::Path => bucket.with_path_style(),
            nuxx_media::config::S3AddressingStyle::Virtual => bucket,
        };
        Ok(Self {
