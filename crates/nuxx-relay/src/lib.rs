...
/// `docs/spec/MultiTenantRelay.tla` by the independent `nuxx-conformance`
/// checker.
pub mod conformance;
...
/// Inter-relay mesh startup wiring (`NUXX_MESH` seam).
pub mod mesh_boot;
...
/// Workflow action sink — relay-side implementation of [`nuxx_workflow::ActionSink`].
