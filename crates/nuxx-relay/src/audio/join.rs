...
//! [`MeshStreamFrame::Data`](nuxx_relay_mesh::MeshStreamFrame). Their layout is
...
/// [`MeshStreamFrame::Data`](nuxx_relay_mesh::MeshStreamFrame)`.payload`,
...
mod tests {
    ...
    use nuxx_relay_mesh::{BoxFuture, StreamRecvHalf, StreamSendHalf};
    ...
    impl RelayPeerTransport for NullTransport {
        ...
        fn set_inbound(&self, _handler: Box<dyn nuxx_relay_mesh::InboundHandler>) {}
    }
