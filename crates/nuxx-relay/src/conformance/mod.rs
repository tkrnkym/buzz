...
//! from `nuxx-conformance`. See `crates/nuxx-conformance/src/lib.rs` for
...
fn project_row_community(
    ...
    channel_communities: &std::collections::HashMap<Uuid, nuxx_core::CommunityId>,
