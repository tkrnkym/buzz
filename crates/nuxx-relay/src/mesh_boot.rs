...
use nuxx_relay_mesh::endpoint::MeshEndpoint;
use nuxx_relay_mesh::gossip::GossipRecord;
use nuxx_relay_mesh::registry::{ReadyRecord, ReadyRegistry};
use nuxx_relay_mesh::{
...
const PROTO_VERSION: u16 = nuxx_relay_mesh::WIRE_VERSION as u16;
...
pub async fn boot_mesh(
    ...
    nuxx_relay_mesh::runtime::spawn_registry_heartbeat(
        registry.clone(),
        ready_record,
...
mod tests {
    ...
    fn session_hello(sender: RuntimeId, profile: Profile) -> StreamHello {
        StreamHello {
            sender,
            role: nuxx_relay_mesh::StreamRole::Session {
                fenced: FencedHeader {
    ...
    async fn wired_datagram_consumer_shares_the_handle_fence() {
        ...
        impl nuxx_relay_mesh::RelayPeerTransport for NoopTransport {
