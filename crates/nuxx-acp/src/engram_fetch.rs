...
use nuxx_core::engram::{conversation_key, d_tag, select_head, validate_and_decrypt, Body};
...
async fn fetch_core_body(
    ...
    let d = d_tag(&k_c, nuxx_core::engram::CORE_SLUG);
...
mod tests {
    use super::*;
    use nuxx_core::engram::{build_event, Body};
    use serde_json::json;
