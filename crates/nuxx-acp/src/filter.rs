...
///   `str_ends_with`, `str_len` (duplicated intentionally from nuxx-workflow).
...
/// `str_len` — duplicated from nuxx-workflow intentionally so this crate
/// has no runtime dependency on nuxx-workflow.
