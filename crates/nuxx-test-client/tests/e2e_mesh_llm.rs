...
//! | 5 | dropped member → typed auth failure reaches lastError | runbook (desktop harness) | nuxx-agent `-32001` unit |
...
/// B running a mesh client + a launched nuxx-agent pointed at B's local
