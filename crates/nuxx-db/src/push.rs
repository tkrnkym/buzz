...
pub(crate) const PUSH_GATE_LOCK_NAMESPACE: &str = "nuxx_push_gate:";
...
pub struct BatchedMatch {
    ...
    pub event: nuxx_core::StoredEvent,
    /// Attempt number, starting at one for the first claim.
    pub attempt: i32,
}
...
where
    ...
    Fut: std::future::Future<Output = Result<Vec<nuxx_core::StoredEvent>>>,
{
