...
/// Re-export kind constants so consumers don't need nuxx-core directly.
pub use nuxx_core::kind;
...
pub use nuxx_core::channel::canonical_channel_name;
/// Channel type.
pub use nuxx_core::channel::ChannelType as ChannelKind;
/// Channel visibility.
pub use nuxx_core::channel::ChannelVisibility as Visibility;
/// Member role.
pub use nuxx_core::channel::MemberRole;
