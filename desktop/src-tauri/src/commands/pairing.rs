...
use nuxx_core_pkg::kind::KIND_PAIRING;
use nuxx_core_pkg::pairing::qr::encode_qr;
use nuxx_core_pkg::pairing::session::PairingSession;
use nuxx_core_pkg::pairing::types::{AbortReason, PayloadType};
...
/// Parse a relay EVENT message into a nostr 0.36 Event (nuxx-core compatible).
